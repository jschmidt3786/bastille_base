...
function __promptline {
  ...
  local a_bg="${wrap}48;5;76${end_wrap}"
  local a_sep_fg="${wrap}38;5;76${end_wrap}"
  ...
  local y_bg="${wrap}48;5;242${end_wrap}"
  local y_sep_fg="${wrap}38;5;242${end_wrap}"
  local z_fg="${wrap}38;5;235${end_wrap}"
  local z_bg="${wrap}48;5;76${end_wrap}"
  local z_sep_fg="${wrap}38;5;76${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
